                    ...
                    <motion.div className="experience-item" whileHover={{ scale: 1.02 }}>
                        <ul>
                            <li>
                                ...
                                monitoring for students from 7 to 17 as well as for High Potential (HP) children & teenagers.
                            </li>
                            <li>
                                Discover this amazing educative game to develop Emotional Intelligence (EQ) and to improve leadership.
                            </li>
                            <li>
