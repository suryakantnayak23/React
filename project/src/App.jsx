        ...
        <div className={`portfolio-container ${isDarkMode ? 'dark-mode' : ''}`}>
            ...
            <header>
                ...
                >
                    ...
                    <div className="contact-info">
                        ...
                        <motion.p whileHover={{scale: 1.1}}>suryakantnayak40@gmail.com</motion.p>
            ...
            <Tilt options={{max: 15, scale: 1.05}}>
                <section className="summary glass-effect" data-aos="fade-up">
                    ...
                    <p>A versatile developer with 1 year of experience in developing and managing websites and internal
                        frameworks, specializing in ReactJS, JavaScript, Spring Boot, and responsive design. I am driven
                        to work
                        in a technical role that enriches my knowledge, allowing me to contribute to corporate growth
                        through my
                        initiative and skills. I aim to excel in a dynamic corporate environment while upholding
                        essential values
                        and principles.</p>
                </section>
            </Tilt>
                    ...
                    >
                        ...
                        <ul>
                            <li>I worked at Think Talent Services, focusing on LMS tool APIs
                                Designed APIs, structured JSON lists, and single JSON objects efficiently by
                                understanding business
                                logic
                                Iterated through API data using map, filter, or functional operations within JSX
                                components
                                Utilized React hooks for state management, and implemented React Query for handling
                                multiple mutations
                                within components
                                Maintained and implemented a component-based architecture to ensure code
                                maintainability.
                                Upgraded projects from React 16 to React 18 across various live projects. Integrated
                                RESTful APIs for
                                serialization and data binding, ensuring seamless data flow.
                                Ensured cross-browser compatibility, and addressed performance issues across platforms
                                and devices
                            </li>
            ...
            <Tilt options={{max: 15, scale: 1.05}}>
                <section className="experience glass-effect" data-aos="fade-up">
                    ...
                    >
                        <ul>
                            <li>LMS User Side Platform, React Strap, Spring Boot, Spring Boot backend-based process for
                                Think Talent
                                country-wise requirement developed through Think Talent managed NextV3 platforms. PMS,
                                HTML5, Spring
                                Boot, Bootstrap 5, JavaScript, React JS, Giving feasibility to clients to assign modules
                                for users,
                                monitoring for students from 7 to 17 as well as for High Potential (HP) children &
                                teenagers. Discover
                                this amazing educative game to develop Emotional Intelligence (EQ) and to improve
                                leadership. Employee
                                Management System, HTML5, CSS3, Bootstrap, JavaScript, Management site that provides a
                                platform for
                                experts of any kind to create courses which can be offered to the public for both
                                corporate users and
                                individual users.
                            </li>
                            <li>Developed APIs, tests, and design patterns</li>
            ...
            <footer className="glass-effect" style={{padding: "2rem", marginTop: "2rem", textAlign: "center"}}>
                <motion.a
                    href="https://github.com/suryakantanayak23?tab=repositories"
                    target="_blank"
                    rel="noopener noreferrer"
                    whileHover={{scale: 1.1}}
                ...
                <p style={{marginTop: "1rem"}}>&copy; {new Date().getFullYear()} Suryakanta Nayak. All rights
                    reserved.</p>
            </footer>
        </div>
    )
